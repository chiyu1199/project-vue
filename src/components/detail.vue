    ...
    <div class="container">
      ...
      <div class="row gary-bg">
        <div class="white-bg p10 details_con">
          ...
          <ul>
            <li>
              ...
              <span class="price">
                ¥
                <span class="price" id="prodCash">179.00</span>
              </span>
            </li>
        ...
        <div id="goodsContent" class="goods-content white-bg">
          ...
          <div class="tempWrap" style="overflow:hidden; position:relative;">
            <div
              style="width:100%; position: relative; overflow: hidden; padding: 0px; margin: 0px; transition-duration: 200ms; transform: translateX(0px);"
              class="bd"
            >
              <ul
              ...
              >
                <div class="prop-area" style="min-height:300px;overflow: hidden;">
                  <img src="../assets/img/01d5dc75-9e5d-405f-bf93-5793fec72e24.jpg" alt>
                </div>
              </ul>
              <!-- <ul
                class="txt-imgs"
              ...
              >
                ...
                <div class="wap_page" style="display: none;" onclick="next_comments(this)">
                  <span>下一页</span>
                </div>
              </ul>
            </div>
