!(function(e) {
  ...
  (n.version = "2.0.4"),
    ...
    (n.render = function(e, r) {
      var t =
        n.get(e) || a({ id: e, name: "Render Error", message: "No Template" });
      return t(r);
    }),
    ...
    i = (function() {
      ...
      return function(r, a, i) {
        ...
        var f = n.openTag,
          ...
          h = "",
          m = 1,
          v = { $data: 1, $id: 1, $helpers: 1, $out: 1, $line: 1 },
          y = {},
          ...
          k = "function($text){" + T + "}",
          E =
            "function(id,data){data=data||$data;var $text=$helpers.$include(id,data,$id);" +
            T +
            "}";
